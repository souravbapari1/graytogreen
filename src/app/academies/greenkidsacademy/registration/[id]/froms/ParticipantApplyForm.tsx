        ...
        <div className="grid md:grid-cols-2 gap-5 mt-4">
          <div className="">
            ...
            <p className="text-sm">
              ...
              enim corporis quisquam deleniti vero, debitis culpa architecto,
              optio repellat ab nobis rem unde rerum? Nostrum inventore magni
              officia sunt quas!
            </p>
          </div>
...
export default ParticipantApplyForm;
