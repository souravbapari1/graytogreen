    ...
    <div className="relative w-full overflow-hidden">
      ...
      <div className="grid lg:grid-cols-2  lg:gap-16 gap-8 container mt-10">
        ...
        <div className="">
          <h1
            className={
              montserrat.className + " lg:text-5xl lg:mt-10 text-3xl font-bold"
            }
          >
            <span className="text-main">Global</span> Board of the{" "}
            <span className="text-main">Plant</span> for the Planet Initiative
          </h1>
          <p className={montserrat.className + " lg:text-2xl mt-10 "}>
            Plant-for-the-Planet thrives on the most outstanding children and
            young people. To spread the word, we have a Global Board with young
            leaders around the world. They are committed to climate justice and
            tree planting on a voluntary basis. The Global Board is elected
            every year.
          </p>
          <Link
            href="#"
