      ...
      {cardData && (
        <div>
          {cardData.map((e, i) => {
            return (
              <div
                className="container grid lg:grid-cols-2 gap-10 mt-12 order-"
                key={e.id}
              >
          ...
          {/* <div className="container grid lg:grid-cols-2 gap-10 mt-12">
            ...
            <div className="md:text-left text-center md:mt-20">
              ...
              <p className="md:text-lg  mt-5">
                Over 100,273 children and youth have already been trained at
                1,866 academies in 76 countries, where we teach each other about
                the climate crisis. As Climate Justice Ambassadors we fight for
                our future by planting trees, giving speeches, protesting, and
                much more.
              </p>
              <Link
                href="#"
