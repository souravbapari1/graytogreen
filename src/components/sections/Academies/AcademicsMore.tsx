...
function AcademicsMore({
  ...
  data?: GreenKidsAcademy["cards"];
  flowChatImage?: string;
  flowChatMobileImage?: string;
  ...
  return (
    <div>
      <div className="container">
        <h1
          ...
          dangerouslySetInnerHTML={{
            __html: flowChatTitle || "Academic Flow Chart",
          }}
        />
        <Image
          src={strApi + flowChatImage}
      ...
      <div className="overflow-hidden">
        <Image
          src={strApi + flowChatMobileImage}
